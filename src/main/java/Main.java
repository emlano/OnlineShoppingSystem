public class Main {
    public static void main(String[] args) {
        ...
        // Clothing c1 = new Clothing("A1B4U3I98", "Cowboy Hat", 544.99, 10, Size.L, "Brown");
        // Clothing c2 = new Clothing("Z1E45A4L8", "Polo Shirt", 34.55, 5, Size.XXL, "White");
        // Clothing c3 = new Clothing("P13SFF078", "Blue Jeans", 199.00, 8, Size.S, "Blue");
        // Clothing c4 = new Clothing("I13F5B5VC", "Yellow Hoodie", 83.95, 3, Size.XL, "Yellow");
        // Clothing c5 = new Clothing("H7C4H99NS", "Cargo Pants", 199.95, 1, Size.XS, "Black");
